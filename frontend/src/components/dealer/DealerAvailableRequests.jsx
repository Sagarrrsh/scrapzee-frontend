...
const DealerAvailableRequests = ({ token, categories }) => {
            ...
            {requests.map(req => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full mt-4 py-2 bg-gradient-to-r from-green-500 to-blue-500 text-white rounded-lg font-semibold hover:shadow-lg transition-all"
                >
                  View Details
                </button>
              </div>
