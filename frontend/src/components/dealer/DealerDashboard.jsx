...
const DealerDashboard = ({ user, token, setCurrentPage, handleLogout }) => {
        ...
        <>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-sm opacity-90">View & Accept New Requests</p>
            </button>
            ...
            >
              ...
              <p className="text-sm text-gray-600">Manage Accepted Requests</p>
            </button>
