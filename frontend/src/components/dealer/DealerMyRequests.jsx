...
import { Package, Loader2, CheckCircle, AlertCircle, X } from 'lucide-react';

const API_BASE = '/api';

const DealerMyRequests = ({ token, categories }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold text-gray-800 mb-8">My Requests</h1>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {requests.map(req => (
              ...
              >
                ...
                <div className="text-xs text-gray-500 pt-3 border-t border-gray-100 mb-3">
                  Accepted: {new Date(req.accepted_at).toLocaleDateString('en-IN', {
                    year: 'numeric',
                    month: 'short',
                    day: 'numeric'
                  })}
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md" onClick={(e) => e.stopPropagation()}>
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-gray-800">Complete Request</h2>
              ...
              <div className="mb-6 bg-gradient-to-r from-green-50 to-blue-50 p-4 rounded-lg">
                <p className="font-bold text-gray-800">Request #{selectedRequest.id}</p>
