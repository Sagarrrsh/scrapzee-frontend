    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {role === 'dealer' ? (
        <>
          ...
          {currentPage === 'dealer-available' && <DealerAvailableRequests token={token} categories={categories} onRequestAccepted={fetchDashboard} />}
          {currentPage === 'dealer-requests' && <DealerMyRequests token={token} categories={categories} onRequestCompleted={fetchDashboard} />}
        ...
        <>
          ...
          {currentPage === 'requests' && <CustomerMyRequests token={token} setCurrentPage={setCurrentPage} user={user} categories={categories} onStatusChange={fetchDashboard} />}
        </>
      )}
    </div>
  );
