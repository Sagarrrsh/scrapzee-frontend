    ...
    <div className="max-w-4xl w-full">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <p className="text-gray-600 mb-4">Sell your scrap materials and earn money with doorstep pickup</p>
        ...
        >
          ...
          <p className="text-gray-600 mb-4">Accept pickup requests and manage your scrap business</p>
...
function App() {
  ...
  if (role === 'dealer') {
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        {currentPage === 'dealer-dashboard' && <DealerDashboard user={user} token={token} setCurrentPage={setCurrentPage} handleLogout={handleLogout} />}
        {currentPage === 'dealer-available' && <DealerAvailableRequests token={token} categories={categories} />}
        {currentPage === 'dealer-requests' && <DealerMyRequests token={token} categories={categories} />}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Navigation user={user} currentPage={currentPage} setCurrentPage={setCurrentPage} handleLogout={handleLogout} />
      {currentPage === 'dashboard' && <CustomerDashboard user={user} dashboard={dashboard} dashboardLoading={dashboardLoading} setCurrentPage={setCurrentPage} handleLogout={handleLogout} />}
      {currentPage === 'pricing' && <PricingPage user={user} categories={categories} categoriesLoading={categoriesLoading} setCurrentPage={setCurrentPage} token={token} onRequestCreated={fetchDashboard} handleLogout={handleLogout} />}
      {currentPage === 'profile' && <CustomerProfile user={user} token={token} setCurrentPage={setCurrentPage} handleLogout={handleLogout} />}
      {currentPage === 'requests' && <CustomerMyRequests token={token} setCurrentPage={setCurrentPage} handleLogout={handleLogout} user={user} categories={categories} />}
    </div>
  );
}
